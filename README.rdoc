{<img src="https://travis-ci.org/subakva/haproxy-tools.svg?branch=master" alt="Build Status" />}[https://travis-ci.org/subakva/haproxy-tools]
= haproxy-tools
...
== Managing the Server List
  ...
  logs.servers['logs4'] = HAProxy::Server.new('logs4', '127.0.0.1', '80', {}) # Add a new server
...
Copyright (c) 2011-2018 Jason Wadsworth. See LICENSE.txt for further details.
